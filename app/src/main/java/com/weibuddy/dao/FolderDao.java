...
public class FolderDao extends AbstractDao<Folder, String> {
    ...
    public static class Properties {
        ...
        public final static Property Version = new Property(2, int.class, "version", false, "VERSION");
        public final static Property Fresh = new Property(3, int.class, "fresh", false, "FRESH");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FOLDER\" (" + //
                ...
                "\"FRESH\" INTEGER NOT NULL );"); // 3: fresh
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Folder entity) {
        ...
        stmt.bindLong(4, entity.getFresh());
    }
    ...
    public Folder readEntity(Cursor cursor, int offset) {
        Folder entity = new Folder( //
            ...
            cursor.getInt(offset + 2), // version
            cursor.getInt(offset + 3) // fresh
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Folder entity, int offset) {
        ...
        entity.setVersion(cursor.getInt(offset + 2));
        entity.setFresh(cursor.getInt(offset + 3));
     }
